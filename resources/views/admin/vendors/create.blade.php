...
@section('script')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCSV6ZvoTSOSOjnvgPENNj4dMDoWMsYMuI&libraries=places&callback=initAutocomplete&language=ar&region=syria
         async defer"></script>
@stop
